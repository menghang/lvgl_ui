...
void setup_scr_scrPowerMeter(lv_ui *ui){
	...
	lv_obj_set_pos(ui->scrPowerMeter_labelVol, 15, 150);
	...
	lv_style_set_text_font(&style_scrpowermeter_labelvol_main_main_default, &lv_font_MONACO_40);
	...
	lv_obj_set_pos(ui->scrPowerMeter_labelCur, 15, 200);
	...
	lv_style_set_text_font(&style_scrpowermeter_labelcur_main_main_default, &lv_font_MONACO_40);
	...
	lv_obj_set_pos(ui->scrPowerMeter_labelPwr, 15, 250);
	...
	lv_style_set_text_font(&style_scrpowermeter_labelpwr_main_main_default, &lv_font_MONACO_40);
	...
	lv_obj_set_pos(ui->scrPowerMeter_imgLogo, 0, 20);
